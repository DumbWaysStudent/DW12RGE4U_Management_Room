...
class Login extends Component {
  ...
  componentDidMount = async () => {
    console.log(this.props.loginLocal);
  }
      ...
      <SafeAreaView>
        <KeyboardAvoidingView behavior='position' style={styles.container}>
          <View style={[styles.textInfo, styles.textInfoTop]}>
            <Image source={{ uri: 'https://pix10.agoda.net/hotelImages/104/104972/104972_16072716330044991252.jpg?s=1024x768' }} style={styles.title} />
...
const mapDispatchToProps = dispatch => {
  return {
    getLogin: (email, password) => dispatch(actionLogin.handleActionLogin(email, password)) 
  };
};
